...
public class participation {
    ...
    private long neutre;
    private long contre;
    //Just used to facilitate the recap at the end of the poll
    ...
    public participation(String nameUser,long pour, long neutre, long contre, fr.vote.proj.domain.vote vote,
